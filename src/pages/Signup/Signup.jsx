...
import sigupImage from "../../assets/images/signup.svg";
...
const Signup = () => {
  ...
  const handleRegister = (e) => {
    ...
    //TODO: password character validation
  ...
  return (
    <>
      <Helmet>
        ...
        <title>Signup - ReactStarter</title>
      </Helmet>
        ...
        <div className="container h-full px-6 py-24">
          <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
            <div className="mb-12 md:mb-0 hidden lg:block md:w-8/12 lg:w-6/12">
              <img src={sigupImage} className="w-full" alt="login-image" />
            </div>
